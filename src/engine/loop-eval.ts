 ...
 *
 * PORTED from lastlight/src/workflows/loop-eval.ts (Phase 1 shared core). Behaviour
 * preserved; only minimal adjustments for this repo's `noUncheckedIndexedAccess`.
 */
