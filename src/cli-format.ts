 ...
 *
 * Ported near-verbatim from `~/work/lastlight/src/cli-format.ts` (Phase 2 CLI
 * port). Adaptation only: `widths[i]!` non-null assertions to satisfy
 * `noUncheckedIndexedAccess` (the index is always in range — behaviour
 * unchanged).
 */
